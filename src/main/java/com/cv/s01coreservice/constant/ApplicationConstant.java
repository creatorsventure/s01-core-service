package com.cv.s01coreservice.constant;
...
public class ApplicationConstant {
    ...
    public static final String APP_NAVIGATION_METHOD_UPDATE_STATUS = "/update-status";
    public static final String APP_NAVIGATION_METHOD_READ_ONE = "/read-one";
    public static final String APP_NAVIGATION_METHOD_READ_PAGE = "/all";
